...
module.exports = function reifyValuesToSet(valuesToSet, WLModel, meta) {
    ...
    const useObjectIds = !meta || !meta.modelsNotUsingObjectIds || !_.contains(meta.modelsNotUsingObjectIds, WLModel.identity);
    ...
    const pkValue = valuesToSet[primaryKeyColumnName];
